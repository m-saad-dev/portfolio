<div class="table-responsive">
    ...
    <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9" style="max-width: inherit !important;">
        ...
        <thead class="border-gray-200 fs-5 fw-semibold bg-lighten">
            <tr>
                <th class="min-w-70px max-w-100% mr-3">#</th>
        ...
        <tbody class="fw-6 fw-semibold text-gray-600" style="max-width: inherit !important;">
            ...
            <tr>
                <td class="min-w-70px max-w-100% mr-3">
                ...
                <td>
                    <p href="javascript::void(0);" class="text-hover-primary text-gray-600">{{$portfolio->name}}</p>
                </td>
                <td>
                    <p href="javascript::void(0);" class="text-hover-primary text-gray-600">{{$portfolio->type}}</p>
                </td>
                <td>
                    <p href="javascript::void(0);" class="text-hover-primary text-gray-600">{{$portfolio->date}}</p>
                </td>
                <td class="text-start">
                    <!--begin::Actions-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 justify-content-center align-center" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="{{route('admin.portfolios.edit', $portfolio->id)}}" class="menu-link px-3">edit</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <form method="post" id="my_form" class="menu-item px-3" action="{{route('admin.portfolios.destroy', $portfolio->id)}}">
                            @csrf @method('Delete')
